...
RUN curl -fsSL https://apt.releases.hashicorp.com/gpg | apt-key add - \
    ...
    && apt-get update \
    && apt-get -y --no-install-recommends install terraform=1.0.2 g++ gcc libc6-dev libffi-dev libgmp-dev make xz-utils zlib1g-dev git gnupg netbase \
    # Clean up
...
# Disable below: we don't want a gitconfig 
# Git update alias
